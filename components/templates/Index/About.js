    ...
    <div class="container-fluid py-5">
      <div class="container">
        <div class="section-title">
          ...
          <h1 class={`${styles.display_4} font_vazir_ExtraBold`}>از سال 1395</h1>
        </div>
        <div class="row">
          <div class="col-lg-4 py-0 py-lg-5">
            <h1 class="mb-3  font_vazir_ExtraBold">داستان ما</h1>
          ...
          <div class="col-lg-4 py-0 py-lg-5">
            <h1 class="mb-3  font_vazir_ExtraBold">هدف ما</h1>
