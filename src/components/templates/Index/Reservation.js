            ...
            <div className="col-lg-6 my-5 my-lg-0">
              <div className="p-5">
                ...
                <p className="text-white font_vazir_Medium">
                  ...
                  رزرو آنلاین بهترین انتخاب شما خواهد بود.
                </p>
                ...
                <form className="mb-5">
                  ...
                  <div className="form-group">
                    <div className="date" id="date">
                      <DatePicker
                        ...
                        locale={persian_fa}
                        value={day}
                        onChange={(date) => setDay(date ? date.toString() : "")}
                  ...
                  <div className="form-group">
                    <select
                      ...
                      style={{ height: "49px" }}
                      value={countPeople}
                      onChange={(event) => setCountPeople(event.target.value)}
                    >
                  ...
                  <div>
                    ...
                    >
                      {isLoading ? "لطفا صبرکنید" : "همین حالا رزرو کنید"}
                    </button>
                  </div>
                </form>
              </div>
